...
<body>
  <div style="display:none;max-height:0;overflow:hidden;">Your GPSFDK email verification code is ${otp}</div>
  <div class="container">
    <!-- Header -->
    ...
    <div class="body" style="padding: 45px 40px; text-align: center;">
      ...
      <h2 style="color: #333; margin: 0; font-size: 24px;">Verify Your New Email</h2>
      <p style="color: #666; margin-top: 15px; font-size: 15px; line-height: 1.6;">
        Hi ${userName},<br>
        You requested to update your email address. Use the code below to verify this email:
      </p>
    ...
    <div style="background: #f0f0f0; padding: 25px 40px; text-align: center; font-size: 12px; color: #888;">
      ...
      <p style="margin: 6px 0 0;">support@gpsfdk.com</p>
    </div>
  </div>
</body>
</html>
...
module.exports = emailUpdateOtpTemplate;
