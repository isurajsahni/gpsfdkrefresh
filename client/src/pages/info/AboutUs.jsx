  ...
  return (
    <div className="min-h-screen bg-primary text-secondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4 text-secondary">About Us</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="bg-secondary/5 aspect-square rounded-2xl flex items-center justify-center p-8">
              <span className="text-secondary/50 text-2xl font-heading">Our Story</span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl font-heading font-bold mb-6 text-secondary">Crafted with Passion</h2>
