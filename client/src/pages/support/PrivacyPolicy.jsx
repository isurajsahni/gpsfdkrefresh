  ...
  return (
    <div className="min-h-screen bg-primary text-secondary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-heading font-bold mb-10 text-secondary">Privacy Policy</h1>
          ...
          <div className="prose prose-lg max-w-none text-secondary/80">
            ...
            <h2 className="text-2xl font-heading font-bold text-secondary mt-8 mb-4">Information We Collect</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-heading font-bold text-secondary mt-8 mb-4">How We Use Your Information</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-heading font-bold text-secondary mt-8 mb-4">Security</h2>
            <p className="mb-6">
