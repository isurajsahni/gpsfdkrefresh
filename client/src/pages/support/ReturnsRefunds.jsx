  ...
  return (
    <div className="min-h-screen bg-white text-primary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-heading font-bold mb-10 text-primary">Returns & Refunds</h1>
          
          <div className="prose prose-lg max-w-none text-primary/80">
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">Our Guarantee</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">Standard Returns</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">Customized Items</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">Refund Process</h2>
            <p className="mb-6">
